...
function onError(err) {
  ...
  return loading ? (
    ...
    <div>
      <Helmet>
        <title>Commandes {orderId}</title>
      </Helmet>
      <h1 className="my-3">Commande N°: {orderId}</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Infoirmation client</Card.Title>
              <Card.Text>
                <strong>Nom Complet:</strong> {order.shippingAddress.fullName}{" "}
                <br />
              ...
              {order.isDelivered ? (
                <MessageBox variant="success">
                  Date de livraison {order.deliveredAt}
                </MessageBox>
              ) : (
                <MessageBox variant="danger">Non livrée</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Methode de paiement</strong> {order.paymentMethod}
              </Card.Text>
              {order.isPaid ? (
                <MessageBox variant="success">
